        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-xl text-gray-300">
              Experience the next level of mobile innovation with our powerful and intuitive Android application.
            </p>
      ...
      <section id="download" className="py-20 bg-gray-800/50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied users and download our app now. Available on Google Play Store.
          </p>
